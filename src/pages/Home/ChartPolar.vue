...
export default {
    ...
    async created() {
        this.chartData.datasets[0].data[0] = this.xs
        this.chartData.datasets[0].data[1] = this.g
        this.chartData.datasets[0].data[2] = this.k
        this.chartData.datasets[0].data[3] = this.tb
    }
...
<template>
    <PolarArea :chart-data="chartData" />
</template>